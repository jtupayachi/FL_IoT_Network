...
with open(r'/Users/user/Library/CloudStorage/GoogleDrive-jtupayac@vols.utk.edu/My Drive/Own Reseach/FLResults/multiples/4clients/1684535204/out_server_4.txt3',"r") as fi:
    file1 = []
    for ln in fi:
...
with open(r'/Users/user/Library/CloudStorage/GoogleDrive-jtupayac@vols.utk.edu/My Drive/Own Reseach/FLResults/multiples/4clients/1684535612/out_server_4.txt3',"r") as fi:
    file2 = []
    for ln in fi:
        if ln.startswith("metrics.matthews_corrcoef => "):
...
with open(r'/Users/user/Library/CloudStorage/GoogleDrive-jtupayac@vols.utk.edu/My Drive/Own Reseach/FLResults/multiples/4clients/1684535951/out_server_4.txt3',"r") as fi:
    file3= []
    for ln in fi:
        if ln.startswith("metrics.matthews_corrcoef => "):
