...
Aggregation functions for strategy implementations. This file was not edited.
It contains a set of predefined functions for metrics aggregation and score averaging
