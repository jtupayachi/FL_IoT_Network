...
DATA_FILE_NAME_SECOND='_ddf_LSTM.pkl'#M3_4_4
DFN_TEST_X='30_2_15_15_combined_offset_misalignment_M3.csv__client_centralizedtest_inputs.pkl'
DFN_TEST_Y='30_2_15_15_combined_offset_misalignment_M3.csv__client_centralizedtest_out.pkl'
...
def client_fn(cid: str) -> fl.client.Client:
    ...
    # model_definition(df,test_inputs,test_out,RNDSEED)
    ...
    # Load data partition (divide MNIST into NUM_CLIENTS distinct partitions) JT CHANGES USING ITERATOR TO PICK DIFFERENT FILE!!!
