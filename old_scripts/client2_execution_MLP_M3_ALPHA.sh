...
for var in $alphas; do
    ...
    for var2 in $slr; do
        ...
        #     sleep 300
        #     echo -n "_FedAvgM"
        #     python3 fl_testbed/version2/client/federated_client_OFFSET_FedAvgM.py -cn 1  -cm 5 -e 1  -ip  172.18.0.8  -dfn_test_x   '100_1_15_15_combined_offset_misalignment_M3.csv__client_centralizedX_test.pkl' -dfn_test_y   '100_1_15_15_combined_offset_misalignment_M3.csv__client_centralizedy_test.pkl' -dfn 'M3_5_1_ddf_MLP.pkl' 2>&1 | tee MLP_CLIENT2_FedAvgM_${var}_slr_${var2}_${var3}.txt
        #     echo "done"
        # done
        ...
        for var4 in $FedOpt_tau; do
            ...
            sleep 300
            echo -n "_FedOpt"
            python3 fl_testbed/version2/client/federated_client_OFFSET_FedOpt.py -cn 1  -cm 5 -e 1  -ip  172.18.0.8  -dfn_test_x   '100_1_15_15_combined_offset_misalignment_M3.csv__client_centralizedX_test.pkl' -dfn_test_y   '100_1_15_15_combined_offset_misalignment_M3.csv__client_centralizedy_test.pkl' -dfn 'M3_5_1_ddf_MLP.pkl' 2>&1 | tee MLP_CLIENT2_FedOpt_${var}_slr_${var2}_${var4}.txt
            echo "done"
        done
        ...
        #     sleep 300
        #     echo -n "_QFedAvg"
        #     python3 fl_testbed/version2/client/federated_client_OFFSET_QFedAvg.py -cn 1  -cm 5 -e 1  -ip  172.18.0.8  -dfn_test_x   '100_1_15_15_combined_offset_misalignment_M3.csv__client_centralizedX_test.pkl' -dfn_test_y   '100_1_15_15_combined_offset_misalignment_M3.csv__client_centralizedy_test.pkl' -dfn 'M3_5_1_ddf_MLP.pkl' 2>&1 | tee MLP_CLIENT2_QFedAvg_${var}_slr_${var2}_${var5}.txt
        #     echo "done"
        # done
