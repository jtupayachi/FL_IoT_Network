...
#         model_type = model_config.get("model_type", "dense") if model_config else "dense"
...
#         with torch.no_grad():
#             if model_type == "lstm":
#                 test_data = torch.randn(100, 10, input_dim)
#             else:
...
#         return loss, {"rmse": rmse, "round": server_round}
...
#         # Generate initial parameters for strategies that need them
#         initial_params = None
#         if strategy_name in ["fedavgm", "fedopt", "moon", "fedala"]:
...
#             # 🔧 FIX: Always provide initial_parameters to avoid empty parameter error
#             initial_params = get_initial_parameters(model_config, input_dim)
...
#                 initial_parameters=fl.common.ndarrays_to_parameters(initial_params),  # ✅ ADD THIS
