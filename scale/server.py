...
#         # Get strategy parameters - ENABLE EVALUATION
#         strategy_name = strategy_config.get("name", "fedavg")
#         fraction_fit = strategy_config.get("fraction_fit", 1.0)
#         fraction_evaluate = strategy_config.get("fraction_evaluate", 1.0)  # Enable evaluation
#         min_fit_clients = strategy_config.get("min_fit_clients", 2)
...
#         print(f"Min Clients: {min_available_clients}")
#         print(f"Fit Fraction: {fraction_fit}")
#         print(f"Eval Fraction: {fraction_evaluate}")
#         print(f"Results Directory: {args.results_dir}")
#         print("=" * 50)
...
#             min_evaluate_clients=min_evaluate_clients,
#             min_available_clients=min_available_clients,
#             evaluate_fn=evaluate_fn,  # This will populate eval_metrics.csv
...
#         print(f"📈 Centralized evaluation will populate: {os.path.join(results_dir, 'eval_metrics.csv')}")
...
#         # Check if eval_metrics.csv has data
#         eval_file = os.path.join(results_dir, "eval_metrics.csv")
#         if os.path.exists(eval_file):
#             with open(eval_file, 'r') as f:
#                 lines = f.readlines()
#                 if len(lines) > 1:
#                     print(f"✅ eval_metrics.csv has {len(lines)-1} records")
#                 else:
#                     print("⚠️ eval_metrics.csv is empty - check evaluation configuration")
