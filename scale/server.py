...
# #     """Custom QFedAvg strategy with metrics collection"""
...
# #     """Custom FedAvgM strategy with metrics collection"""
...
# #     """Custom FedOpt strategy with metrics collection"""
...
# # def run_server(args):
# #     """Run the FL server with support for different strategies and their parameters"""
# #     try:
# #         # Load configuration
# #         with open(args.config, 'r') as f:
# #             config = json.load(f)
...
# #         # Print strategy-specific parameters if any
# #         if strategy_params:
# #             print(f"\n🔧 Strategy Parameters:")
...
# #         # Create strategy based on name with model-specific parameters
...
# #             print(f"   ✓ qffl_learning_rate: {qffl_learning_rate}")
...
# #         else:
# #             raise ValueError(f"Unknown strategy: {strategy_name}. Supported: fedavg, qfedavg, fedavgm, fedopt")
...
#             print(f"   🔧 Generating initial parameters for {strategy_name.upper()}...")
#             initial_params = get_initial_parameters(model_config, input_dim)
#             print(f"   ✓ Initial parameters generated")
...
#                 min_available_clients=min_available_clients,
#                 server_momentum=server_momentum,
#                 initial_parameters=initial_params,  # ← REQUIRED
#                 evaluate_fn=evaluate_fn,
#                 on_fit_config_fn=lambda r: {"current_round": r},
#                 on_evaluate_config_fn=lambda r: {"current_round": r}
#             )
